package com.codepoka.sms_retriever_api
...
class SmsRetrieverApiPlugin(private val context: Activity): MethodCallHandler {
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "com.codepoka.sms_retriever_api")
      channel.setMethodCallHandler(SmsRetrieverApiPlugin(registrar.activity()))
    }
  }
